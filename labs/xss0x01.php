...
<body>
    <main>
        <div class="container py-5">
            ...
            <h2 class="pb-2 border-bottom"><a href="../index.php" class="text-decoration-none">Labs</a> / XSS 0x01</h2>
             <div class="p-5 mb-4 bg-light rounded-3" style="background-color: none !important; padding: 0 !important">
                <img src="../assets/XSS.png" style="width:100%">
            </div>
            <div class="p-5 mb-4 my-color rounded-3 shadow-sm p-3 mb-5 rounded">
                ...
                <ul id="todolist">
                    <?php
                        ...
                        $str = $_GET["search"];
                        echo "No items found for <b>$str</b>";
                    ?>
                </ul>
            </div>
        </div>
