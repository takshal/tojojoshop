...
<body>
	  <main>
       <div class="container py-5">
            ...
            <h2 class="pb-2 border-bottom"><a href="../index.php" class="text-decoration-none">Labs</a> / XSS 0x06</h2>
            ...
            ini_set("display_errors", 0);  $str = $_GET["search"];  $str2=str_replace("<script","<scr_ipt",$str);
                ...
                <form action="" method="GET">
                    <div class="input-group mb-3">
                        <input type="text" name="search" class="form-control" placeholder="Enter Items" aria-label="Username" value="">
                ...
                <ul id="todolist"> 
               <?php echo "No items found for <b>". $str6; ?></ul>
