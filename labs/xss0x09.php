...
<body>
	  <main>
        <div class="container py-5">
            ...
            <h2 class="pb-2 border-bottom"><a href="../index.php" class="text-decoration-none">Labs</a> / XSS 0x09</h2>
            
            <div class="p-5 mb-4 my-color rounded-3 shadow-sm p-3 mb-5 rounded">
                <h2 class="pb-3">Search items in our tojojo shop</h2>
                <?php 
            ini_set("display_errors", 0);  $str = $_GET["search"]; $str11 = $_GET["t_sort"];
             ?>
                ...
                <form action="" method="GET">
                    ...
                    <input name="t_sort"  value="<?php echo $str11; ?>" type="hidden">
                </form>
               
                <h3 class="pb-3">Your list:</h3>
                <ul id="todolist"> 
              <?php echo "No items found for <b>". $str11 ?> </ul>
