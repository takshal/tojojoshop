...
<body>
	  <main>
        <div class="container py-5">
            ...
            <h2 class="pb-2 border-bottom"><a href="../index.php" class="text-decoration-none">Labs</a> / XSS 0x05</h2>
            
            <div class="p-5 mb-4 my-color rounded-3 shadow-sm p-3 mb-5 rounded">
                <h2 class="pb-3">Search items in our tojojo shop</h2>
                <?php 
            ini_set("display_errors", 0);  $str = $_GET["search"];  $str2=str_replace("<script","<scr_ipt",$str);
            $str3=str_replace("on","o_n",$str2);?>

                <form action="" method="GET">
                    <div class="input-group mb-3">
                        <input type="text" name="search" class="form-control" placeholder="Enter Items" aria-label="Username" value="<?php echo $str3;?>">
                ...
                <ul id="todolist"> 
               <?php echo "No items found for <b>". htmlspecialchars($str); ?></ul>
