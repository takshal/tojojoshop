...
<body>
	  <main>
       <div class="container py-5">
            ...
            <h2 class="pb-2 border-bottom"><a href="../index.php" class="text-decoration-none">Labs</a> / XSS 0x04</h2>
            
            <div class="p-5 mb-4 my-color rounded-3 shadow-sm p-3 mb-5 rounded">
                <h2 class="pb-3">Search items in our tojojo shop</h2>
                <?php 
            ini_set("display_errors", 0);  $str = $_GET["search"];  $str2=str_replace(">","",$str);
