...
<body>
	  <main>
        <div class="container py-5">
            ...
            <h2 class="pb-2 border-bottom"><a href="../index.php" class="text-decoration-none">Labs</a> / XSS 0x08</h2>
            ...
            ini_set("display_errors", 0);  $str = $_GET["search"]; $str2=str_replace("script","scr_ipt",$str);
                ...
                <h3 class="pb-3">Your Link:</h3>
                <ul id="todolist"> 
               <?php echo 'No items found for <a href="' . $str7 . '"> click here to view more details</a>'; ?>
