...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows == 1) {
        ...
        // Set user_id cookie with base64-encoded user ID
        $user_id_base64 = base64_encode($row['id']);
        setcookie('user_id', $user_id_base64, time() + (86400 * 30), "/"); // 30 days expiration
    ...
    <main>
        <div class="container py-5">
            <div class="row justify-content-end">
                <div class="col-auto">
                    <a href="/capstone/index.php" class="btn btn-outline-secondary" data-bs-toggle="modal"
